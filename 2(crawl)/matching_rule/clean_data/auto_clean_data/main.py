...
class clean_data:
    ...
    def delete_repeat_data(self,_id,Article_Keyword,flag=2):#删除重复文章
        return self.db_obj.delete_repeat_data(_id,Article_Keyword,flag)
    def run(self):
        while True:
            try:
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        self.delete_repeat_data(id, data["Article_Keyword"],1)
                    except:
                        a = self.delete_repeat_data(id,data["Article_Keyword"],2)
                        print(a)
