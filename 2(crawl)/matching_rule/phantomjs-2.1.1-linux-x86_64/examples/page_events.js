...
//
//      1. Load URL
//      2(crawl). Load same URL, but adding an internal FRAGMENT to it
...
// NOTE.2(crawl): This script is not here to teach you ANY JavaScript. It's aweful!
...
setTimeout(function() {
    console.log("");
    console.log("### STEP 2(crawl): Load '" + step2url + "' (load same URL plus FRAGMENT)");
    page.open(step2url);
}, 5000);
